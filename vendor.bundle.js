...
/***/ function(module, exports, __webpack_require__) {
	...
	var middleRow = [$("#four"), $("#five"), $("#six")];
	var bottomRow = [$("#seven"), $("#eight"), $("#nine")];
	var firstCol = [$("#one"), $("#four"), $("#seven")];
	var secondCol = [$("#two"), $("#five"), $("#eight")];
	var thirdCol = [$("#three"), $("#six"), $("#nine")];
	var diagonalOne = [$("#one"), $("#five"), $("#nine")];
	var diagonalTwo = [$("#three"), $("#five"), $("#seven")];
	...
	var checkConditions = function checkConditions(winCondition) {
	...
	var hideErthang = function hideErthang() {
	  $('.gameboard').hide();
	  $('.players').find('.playerName').hide();
	};

	//shows the board and player indicator
	var showErthang = function showErthang() {
	  $('.gameboard').show();
	...
	var player1 = $('.players').find('.playerX');
	var player2 = $('.players').find('.playerO');

	//resets the board
	var cleanSlate = function cleanSlate() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patchGame = function patchGame() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var save = function save(success, failure) {
